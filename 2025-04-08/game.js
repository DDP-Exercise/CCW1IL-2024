...
const startGame = function () {
    ...
    // Erstellt input-HTML Element
    const input = document.createElement("input");
    // Setzt den Placeholder in das neu erstellte input-Element
    input.placeholder = "Gib deinen Spielernamen ein";
    // Setzt den type des input-Elements auf Text
    input.type = "text";
    // Setzt die ID des input-Elements auf "nameInput"
    input.id = "nameInput";

    // Erstellt einen Button
    const confirmButton = document.createElement("button");
    // Setzt den Text des neu erstellten Button
    confirmButton.textContent = "Spielername speichern";
    // Setzt die ID des Button-Elements
    confirmButton.id = "confirmButton";

    console.log(input, confirmButton);

    document.getElementById("inputArea").append(input, confirmButton);
    // EventListener auf Button hinzufügen
    confirmButton.addEventListener('click', function () {
        console.log('test')
        // Spielername soll extrahiert werden aus dem input Feld
        spielerName = input.value.trim() ? input.value.trim() : 'anonymer Spieler';
        ...
        // Entferne den erstellten Input und Button aus der div Box
        input.remove();
